...
public class ConfigurationView {
	...
	private void initialize() { // 
		...
		frmConfiguration.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("SettingsIcon.png")));
		frmConfiguration.setTitle("Configuration");
		frmConfiguration.setBounds(500, 150, 750, 600);
		...
		Background.setIcon(new ImageIcon(getClass().getResource("SettingsBackground.png")));
