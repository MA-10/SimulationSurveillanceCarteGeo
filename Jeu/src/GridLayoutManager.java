...
public class GridLayoutManager extends JFrame {
	...
	public GridLayoutManager(ConfigurationModel configuration)
	{
		...
		image= new ImageIcon (getClass().getResource("obstacle.png"));
		
		Create();// creer une grille de button vide 
	...
	private void supprimeEmplacement(Point p,String Emplacement)
	{
		...
		case "Sortie":
			...
			{
				image= new ImageIcon (getClass().getResource("exit.png"));
				if (configuration.Emplac_Obstacle.remove(p)) {
	...
	private void EmplacementAjout (Point p , String Emplacement) {
			...
			case "Sac":
				image= new ImageIcon (getClass().getResource("sac.png"));
				configuration.Emplac_Sac.add(p);break;							
			case "Robots":
				image = null;
				if (configuration.Emplac_Robots.size() <4)
				{
					image= new ImageIcon (getClass().getResource("robot.png"));
			...
			case "Intrus":
				...
				{
					image= new ImageIcon (getClass().getResource("intrus.png"));
