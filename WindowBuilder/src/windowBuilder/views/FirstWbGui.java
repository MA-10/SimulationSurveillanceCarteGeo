...
public class FirstWbGui extends JFrame
{
	...
	private void initComponents()
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(FirstWbGui.class.getResource("/windowBuilder/resources/monkey_128.png")));
	...
	private void createEvents()
	{
		...
		spnSpin.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				sldJimmy.setValue((int)spnSpin.getValue());
			}
		});
